    ...
    <div class="bg-cover bg-center min-h-screen flex items-center justify-center"
        ...
        <div class="w-full max-w-md mx-4">
            <div class="bg-white bg-opacity-90 shadow-xl rounded-xl p-8">
                <h1 class="text-3xl font-bold mb-8 text-center" style="color: #A594F9;">Editar Producte</h1>
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="memory_ram" class="block font-medium mb-2" style="color: #6A5ACD;">Memòria RAM</label>
